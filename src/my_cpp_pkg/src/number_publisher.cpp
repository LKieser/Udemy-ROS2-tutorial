...
public:
    ...
    {
        // declare parameter
        this->declare_parameter("number", 2); // name, default value, will be int
        this->declare_parameter("timer_period", 1.0); // name, default value, will be float
        // get parameter
        ...
        number_timer_ = this->create_wall_timer(std::chrono::duration<double>(timer_period), // use the parameter here
...
private:
    void publishNumber()
    {
        ...
        msg.data = number_; //  use the parameter here
        number_publisher_->publish(msg);
    }

    // only need if you want the param call back
